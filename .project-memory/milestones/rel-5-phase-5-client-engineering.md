...
id: "REL-5"
kind: "milestone"
title: "Phase 5 — Client engineering"
...
Build the client: offline logging vertical slice first, layered access, local SQLite + outbox, sync engine, screens. Skill: client-engineering.
